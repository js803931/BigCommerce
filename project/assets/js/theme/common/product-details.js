...
// custom
import customProductDetails from '../custom/productDetails';
...
export default class ProductDetails {
    constructor($scope, context, productAttributesData = {}) {
        ...
        $(".productReview-body span").each((index, item) => {
        ...
        /*
         * IntuitSolutions.net - product details custom scripts
         */
        customProductDetails(this.$scope);
    }
